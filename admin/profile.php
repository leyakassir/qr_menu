...
<head>
    ...
    <title>Admin Profile - Restaurant QR Menu</title>
    ...
    <nav class="sidebar d-md-block text-white">
        <div class="position-sticky">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link active" href="/qr_menu_Leya_Kassir/admin/profile.php"><i class="fa-solid fa-user"></i> Profile</a></li>
